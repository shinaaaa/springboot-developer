...
import com.example.springbootdeveloper.config.oauth.OAuth2AuthorizationRequestBaseOnCookieRepository;
...
public class WebOAuthSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers(new AntPathRequestMatcher("/api/token"))
                                .permitAll()
                ...
                .exceptionHandling(exceptionHandling -> exceptionHandling.defaultAuthenticationEntryPointFor(new HttpStatusEntryPoint(HttpStatus.UNAUTHORIZED), new AntPathRequestMatcher("/api/**")))
                .build();
    }
    ...
    @Bean
    public OAuth2AuthorizationRequestBaseOnCookieRepository oAuth2AuthorizationRequestBasedOnCookieRepository() {
